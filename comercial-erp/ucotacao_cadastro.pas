...
begin
  if opcao_item = 'I' then
     begin
       ...
       qrexec_base.SQL.Add('insert into master_cotacao_item( prazo,  escolhido,  marger_lucro,  ndanfe,  valor,  cfor,  dif_prazo,    data,  ccotacao ) ');
       qrexec_base.SQL.Add('                     values( :prazo,  :escolhido,  :marger_lucro,  :ndanfe,  :valor,  :cfor,  :dif_prazo,    :data,  :ccotacao) ');
