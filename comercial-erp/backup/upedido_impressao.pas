...
{$R *.lfm}
        ...
        procedure Tfrmpedido_impressao.btncancelarClick(Sender: TObject);
        begin
          close;
        end;

procedure Tfrmpedido_impressao.btnokClick(Sender: TObject);
begin
...
procedure Tfrmpedido_impressao.FormCreate(Sender: TObject);
begin
