...
begin
  ...
  with modulo_pedidovenda do
    begin
      ...
      //qrpedidovenda.SQL.Add('select * from tpedidovenda p where (cast(p.datahoracadastro as date) >= :dti and cast(p.datahoracadastro as date) <= :dtf) ' +filtro+' order by controle');
