     ...
     begin
        ...
        with modulo_conexaodb do
          begin
            ...
            qrexec_base.SQL.Add('insert into tpedidovenda(         codcliente,   cliente,       codfuncionario,   funcionario,   codvendedor,  vendedor,   controlevarchar,     titulodav,             observacao, datahoracadastro, valordesconto,    totalprodutos,  totalliquido            ) ');
            qrexec_base.SQL.Add('                     select       codcliente,   nomecliente,   codfuncionario,   funcionario,   codvendedor,  vendedor,   controlevarchar,     ''PEDIDO DE VENDA'',   observacao, current_time,     0            ,    0            ,  0             from torcamento where controle = :controle ');
