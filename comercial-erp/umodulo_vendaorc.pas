...
begin
     ...
     begin
       ...
       qrvenda_itemproduto.SQL.Add('select p.descricao, d.codigo, d.cpro, d.prve, d.qtde, dp.codigo as codprod from dvenda d left join dprodutos dp on d.cpro = dp.codigo left join produtos p on dp.cdescprod = p.codigo where d.codsvenda = :codsvenda');
